-- 電子部品在庫管理システム用データベース初期化スクリプト

-- データベースの作成（既に存在する場合は無視）
CREATE DATABASE IF NOT EXISTS inventory_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- テスト用ユーザーの権限設定
GRANT ALL PRIVILEGES ON inventory_test.* TO 'test'@'%';
FLUSH PRIVILEGES;
